...
| [13 Actions](13-actions.md)                      | Planned (M9+): targets, `actions:*` scopes, tools, policy, elicitation, scrubbing, audit |
| [14 Action connectors](14-actions-connectors.md) | Planned (M9+): `http` and Graph, `sql`, `ssh`, `winrm`, `browser` contracts and sidecar  |
