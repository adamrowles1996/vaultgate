...
The one-sentence claim is **the agent never holds your credentials**. This page shows what that
means against the other Bitwarden MCP servers, cites what each project's own README says, and ends
with the cases where vaultgate is not the right choice.
...
| Command execution tool                  | No                                                                                                          | No                                                                                                                                                      | No                                                                                                                                                                     | No, by decision ([ADR 0004](adr/0004-no-remote-command-execution.md))                                                                                                   |
...
[12 Compatibility](spec/12-compatibility.md), [ADR 0004](adr/0004-no-remote-command-execution.md).
...
- **Secret injection into commands.** vaultgate has no "run this with the secret" tool by design
  (ADR 0004). If that is the workflow you want, a local server with the `bw` CLI is the right shape.
