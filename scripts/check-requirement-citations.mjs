 ...
 * `browser` connector (spec 13.6.6 and 14.7), which is deliberately
 * unimplemented until that milestone; its tests land with it. Remove an
 * entry when its milestone lands — never to silence this gate.
 */
const ALLOWED = new Map(
  [29, 30, 31, 32, 33, 91, 92, 93, 94, 95, 96, 97, 98, 99, 100, 101, 102].map((number) => [
    `${PREFIX}${number}`,
    'M15',
  ]),
);
