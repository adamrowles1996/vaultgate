 ...
 * `sql_query` tool, the pure policy half (classification, ACT-36…38) and
 * `run` over injected session factories, one per engine (ACT-78).
...
import { sqlQueryTool, type SqlOperation } from './operation.ts';
